...
ALTER PROCEDURE dbo.CreateGrade(@StudentId int, @CourseId int, @TeacherId int)
AS
BEGIN
	INSERT INTO [dbo].[Grade] (StudentId, CourseId, TeacherId)
...
EXEC dbo.CreateGrade @StudentId=291, @CourseId=6,@TeacherId=85
